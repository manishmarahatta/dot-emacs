;;; py-exec.el
;; Description: ess style execution for python
;; Author: rho <rho.rhoit@gmail.com>
;; URL: https://github.com/rhoit/py-exec

;;; Commentary
;; py exec run the python code in the much cooler way some how similar
;; to debugging but completely different.
;;
;; This package is some how similar to the isend-mode
