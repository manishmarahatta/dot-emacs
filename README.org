...
* Intro
  ...
  The original author of this config is [[https://github.com/rhoit/][rhoit dai]]. Below contains his README(his statements).I've been using /emacs/ since of *2012*, and slowly config is grown
