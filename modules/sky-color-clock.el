...
;;
;;   (sky-color-clock-initialize-openweathermap-client "514421b62df525e0d5e5e4440f8837bd" 1850144) ; Tokyo's City ID
;;
  ...
  (let* ((day-of-year                   ; day of year (0-origin)
    ...
    (setq sky-color-clock--bg-color-gradient
          (sky-color-clock--make-gradient
           ...
           (cons (/ (+ sunset sunrise) 2) "#8bd7f5")
           (cons (- sunset  1.2)          "#b3f2e6")
           (cons (- sunset  0.8)          "#f3e693")
           (cons (- sunset  0.4)          "#f86b10")
           (cons sunset                   "#100028")
